...
export default function FAQ() {
  ...
  const items = [
    ...
    { q: "Does MCPeek execute any code?", a: "No. MCPeek performs static analysis and pattern matching only. It never executes, installs, or runs any of the code it scans. URL scanning fetches content but never evaluates it. Your environment stays safe." },
    { q: "What is the AI analysis feature?", a: "MCPeek uses two free AI backends: NVIDIA NIM (13 free models including Llama 3.3, Gemma 3, Qwen, DeepSeek) and OpenRouter (free-tier models). The AI generates context-specific attack scenarios, plain-English risk narratives, and remediation suggestions based on your actual scan findings. All AI calls are rate-limited and cost nothing. The core scanner works without AI." },
    { q: "Is MCPeek free?", a: "Yes. MCPeek is free and open source for public use. Enterprise workspaces, API keys, and support are available for teams that need ownership boundaries." },
