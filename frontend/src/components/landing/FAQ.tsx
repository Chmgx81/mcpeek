...
export default function FAQ() {
  ...
  const items = [
    ...
    { q: "Is MCPeek free?", a: "Yes. MCPeek is free and open source. No account required. The AI analysis feature uses free NVIDIA NIM and OpenRouter models — no credit card needed." },
